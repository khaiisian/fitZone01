...
namespace fitZone01
{
    public partial class fitZone : Form
    {
        int iRowIndex;
        OleDbCommand mycmd;
        ...
        public fitZone()
        {
            ...
            constr = "Provider=Microsoft.ACE.OLEDB.12.0;Data Source=" + Application.StartupPath + @"\fitZone01DB.mdb";
        ...
        void databind()
        {
            try
            {
                ...
                aid = int.Parse(o2.ToString());
            }
            catch (System.FormatException ex) { }

            //lstActivity.SelectedIndex = aid - 1;
        ...
        private void combo_act_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            dataGridView1.DataMember = "UserActMatric";
        ...
        //        //DbClass db = new DbClass();
        //        //uid = GlobalData._UserId;
        //        //aid = lstActivity.SelectedIndex + 1;
        //        //dataGridView1.DataSource = db.getTable(uid, aid);
        //        //dataGridView1.DataMember = "UserActMatric";
        //        //activity = lstActivity.SelectedItem.ToString();

        //    // Lbl changes according to the activity selected in the lstbox
        ...
        private void Metric1txt_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            {
                e.Handled = true;
                MessageBox.Show("This field only accepts numeric data");
                Metric1txt.Text = "";
            }
        }
        ...
        private void save_btn_Click(object sender, EventArgs e)
        {
            ...
            if (activity == "Swimming")
            {
                ...
                if ((m3 <= 30) || (m3 >= 200))
                {
                    MessageBox.Show("The weight of the user should be between 20 to 200 kg", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    return;
                }
                ...
                se.AddSwimmingEx(uid, aid, m1, m2, m3, curCal);

                int tarCal = GlobalData._TargetCalorie;
                decimal totalCal = se.CurrentTotalCal(uid);
                if (totalCal >= tarCal)
                    MessageBox.Show("Congrats!!!You have reached your goal!!!", "Congratulation", MessageBoxButtons.OK, MessageBoxIcon.Information);
                //CalorieBurned_label.Text = "Success";
            ...
            else if (activity == "Walking")
            {
                ...
                if ((m3 < 30f) || (m3 >= 50000f))
                {
                    MessageBox.Show("The steps should be from 20 to 200 kg", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    return;
                }
                ...
                we.InsertWalkingExercise(uid, aid, m1, m2, m3, curCal);
                int tarCal = GlobalData._targetCalorie;
            ...
            else if (activity == "Skipping Rope")
            {
                ...
                if ((m3 < 1f) || (m3 >= 120f))
                {
                    MessageBox.Show("The time duration should be from 1 to 120", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    return;
                }
                ...
                se.AddSkipropeActivity(uid, aid, m1, m2, m3, curCal);
            ...
            else if (activity == "Cycling")
            {
                ...
                ce.AddCyclingEx(uid, aid, m1, m2, m3, curCal);
                int tarCal = GlobalData._targetCalorie;
            ...
            else if (activity == "Jogging")
            {
                ...
                je.AddJogging(uid, aid, m1, m2, m3, curCal);
                int tarCal = GlobalData._targetCalorie;
            ...
            else if (activity == "Yoga")
            {
                ...
                je.AddYoga(uid, aid, m1, m2, m3, curCal);
                int tarCal = GlobalData._targetCalorie;
                decimal totalCal = je.CurrentTotalCal(uid);
                if (totalCal >= tarCal)
                    MessageBox.Show("Congrats!!!You have reached your goal!!!", "Congratulation", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void update_btn_Click(object sender, EventArgs e)
        {
            ...
            response = MessageBox.Show("Do you want to edit the record?", "Information", MessageBoxButtons.YesNo);
            if (response == DialogResult.No) return;
            ...
            try
            {
                ...
                DialogResult dr = MessageBox.Show("Are you sure that you  desire to edit this record ? ", "Update Confirmation ", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
                if (dr == DialogResult.Yes)
                {
                    if (activity == "Swimming")
                    {
                        ...
                        if (totalCal >= tarCal)
                        {
                            MessageBox.Show("Congrats!!!Your goal has been met!!!");

                        }

                        se.UpdateSwimmingEx(mid, uid, aid, m1, m2, m3, curCal);
                        //CalorieBurned_label.Text = "Success";
                    ...
                    else if (activity == "Walking")
                    {
                        ...
                        we.UpdateWalkingExercise(mid, uid, aid, m1, m2, m3, curCal);
                        //CalorieBurned_label.Text = "Success";
                        MessageBox.Show("Record is edited successfully \nPlease Refresh the form", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    }
                    else if (activity == "Skipping Rope")
                    {
                        ...
                        se.UpdateSkipropeActivity(mid, uid, aid, m1, m2, m3, curCal);
                        //CalorieBurned_label.Text = "Success";
                        MessageBox.Show("Record is edited successfully \nPlease Refresh the form", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    }
                    else if (activity == "Cycling")
                    {
                        ...
                        ce.UpdateCyclngEx(mid, uid, aid, m1, m2, m3, curCal);
                        //CalorieBurned_label.Text = "Success";
                        MessageBox.Show("Record is edited successfully \nPlease Refresh the form", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    }
                    ...
                    else if (activity == "Jogging")
                    {
                        ...
                        je.UpdateJogging(mid, uid, aid, m1, m2, m3, curCal);
                        //CalorieBurned_label.Text = "Success";
                        MessageBox.Show("Record is edited successfully \nPlease Refresh the form", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    }
                    ...
                    else if (activity == "Yoga")
                    {
                        ...
                        ye.UpdateYoga(mid, uid, aid, m1, m2, m3, curCal);
                        //CalorieBurned_label.Text = "Success";
                        MessageBox.Show("Record is edited successfully \nPlease Refresh the form", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    }
